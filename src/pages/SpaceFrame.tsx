...
function SpaceFrame(props: {launcher: Launcher}) {
    ...
    const [spaceEntryPoint, setSpaceEntryPoint] = useState<HashedObject & SpaceEntryPoint & WikiSpace|undefined>(undefined);
    ...
    useEffect(() => {
        ...
        const init = async () => {
            ...
            setSpaceEntryPoint(await spaceResources?.store.load(spaceEntryPointHash) as WikiSpace);
        }
