...
import { Hash, MutableArray, Store, WorkerSafeIdbBackend } from '@hyper-hyper-space/core';
// import { HyperBrowserConfig } from './model/HyperBrowserConfig';
import { Home } from '@hyper-hyper-space/home';
import Launcher from './Launcher';

const main = async () => {
  const configBackend = new WorkerSafeIdbBackend('wiki-collab-launcher-' + Launcher.version);
