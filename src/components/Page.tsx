...
function WikiSpacePage(props: {page: Page}) {
    ...
    const addTextBlock = (idx?: number) => {
        ...
        const newBlock = page?.addBlockNoSave(idx, undefined, (launcher?.getAuthor() as Identity)!);
    ...
    const addImageBlock = (dataUrl: string, idx?: number) => {
        ...
        page?.addBlock(idx, BlockType.Image, launcher?.getAuthor() as Identity).then(async (b: Block) => {
                ...
                {(provided) =>  <div
                                ...
                                >
                                    <WikiSpaceBlock
                                        ...
                                        removeBlock={() => page?.removeBlock(block, launcher?.getAuthor())}
